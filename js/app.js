...
let userExp = prompt("Answering more questions will help us improve do you want to answer more?").toLowerCase()

setInput(userExp, userInputs)

let userHappiness = prompt("Are you happy using this site?").toLowerCase()

setInput(userHappiness, userInputs)

let userAddition = prompt("Is there any features you would like to add?").toLowerCase()

setInput(userAddition, userInputs)
